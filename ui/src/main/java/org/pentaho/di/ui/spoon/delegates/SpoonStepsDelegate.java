...
public class SpoonStepsDelegate extends SpoonDelegate {
    ...
    public String editStep(TransMeta transMeta, StepMeta stepMeta) {
        ...
        StepDialogInterface dialog = null;
        try {
            ...
            dialog = spoon.getStepEntryDialog(stepMeta.getStepMetaInterface(), transMeta, name);
            if (dialog != null) {
            ...
            // 解决step dialog窗口打开后刷新死锁问题，异常直接抛出，中断线程
            if ("org.eclipse.rap.rwt.internal.lifecycle.UIThread$UIThreadTerminatedError".equals(e.getClass().getName())) {
                throw e;
            } else {
